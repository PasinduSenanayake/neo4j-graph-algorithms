...
public class AverageDegreeCal extends Algorithm<AverageDegreeCal> {
    ...
    public AverageDegreeCal compute() {
        nodeQueue.set(0);
    ...
    @Override
    public AverageDegreeCal me() {
        return this;
    }

    @Override
    public AverageDegreeCal release() {
        graph = null;
        return null;
    }
